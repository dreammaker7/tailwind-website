export default function About() {
  return (
    <div className="mx-auto px-4 py-10 sm:px-6 md:max-w-4xl lg:max-w-screen-xl lg:px-8">
      <div className="mx-auto max-w-screen-xl items-center gap-16 py-8 lg:grid lg:grid-cols-2 lg:py-16">
        <div className="font-light text-gray-500 dark:text-gray-400 sm:text-lg">
          ...
          <p className="mb-4">
            We are strategists, designers and developers. Innovators and problem solvers. Small enough to be simple and quick, but
            big enough to deliver the scope you want at the pace you need. Small enough to be simple and quick, but big enough to
      ...
      <div className="my-10 text-left">
        <div className="mb-10 text-left">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-white md:text-4xl md:leading-tight">
        ...
        <div className="group relative flex gap-x-5">
          ...
          <div className="grow pb-8 group-last:pb-0">
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
              This is an excellent company and they reward their employees. It's becoming a big company but it's still private, so
              the culture is as good as it gets at 1,000+ employees if you ask me. Managers are still adapting to the growth I
        ...
        <div className="group relative flex gap-x-5">
          ...
          <div className="grow pb-8 group-last:pb-0">
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
              Work in Slack is one of the beautiful experience I can do in my entire life. There are a lot of interesting thing to
        ...
        <div className="text-center">
          <a className="btn-link btn-small my-12 gap-x-2 px-4 py-2" href="#">
            Learn more
            <svg
