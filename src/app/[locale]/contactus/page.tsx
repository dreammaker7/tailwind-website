  ...
  return (
    <div className="mx-auto px-4 py-10 sm:px-6 md:max-w-4xl lg:max-w-screen-xl lg:px-8 lg:py-14">
      <div className="mx-auto mb-6 max-w-2xl text-center sm:mb-10">
        <h2 className="text-2xl font-bold dark:text-white md:text-4xl md:leading-tight">Contacts</h2>
        <p className="mt-1 text-gray-600 dark:text-gray-400">We'd love to talk about how we can help you.</p>
      </div>

      <div className="mb-20 grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
        <div className="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800">
          <img
          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 md:gap-8 lg:gap-12">
              <div className="flex gap-4">
                ...
                <div className="grow">
                  <p className="text-sm text-gray-600 dark:text-gray-400">United Kingdom</p>
      ...
      <div className="mb-16 grid items-center gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        <a
          className="group flex h-full flex-col rounded-lg p-4 text-center hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:hover:bg-gray-500/10 dark:focus:bg-gray-500/10 sm:p-6"
          href="#"
        >
          <svg
            className="mx-auto size-9 text-gray-800 dark:text-gray-200"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-gray-500 dark:text-gray-500">We're here to help with any questions or code.</p>
        ...
        >
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-gray-500 dark:text-gray-500">Search our FAQ for answers to anything you might ask.</p>
            <p className="mt-5 inline-flex items-center gap-x-1 font-medium text-blue-600 dark:text-blue-500">
              Visit FAQ
              <svg
                className="size-4 shrink-0 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-1"
        ...
        >
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-gray-500 dark:text-gray-500">Check out our development quickstart guide.</p>
            <p className="mt-5 inline-flex items-center gap-x-1 font-medium text-blue-600 dark:text-blue-500">
              Contact sales
              <svg
                className="size-4 shrink-0 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-1"
